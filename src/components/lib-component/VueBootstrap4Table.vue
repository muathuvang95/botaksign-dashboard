            ...
            <tr v-if="showToolsRow" class="vbt-table-tools">
              <th :colspan="headerColSpan">
                <div class="vbt-header-row no-gutters">
                  ...
                  <div
                    class="input-group vbt-global-search"
                  ...
                  <RefreshBoard
                    ...
                    :searchSpecialistValue="searchSpecialistValue"
                  ></RefreshBoard>
                ...
                <template v-for="(column, key, index) in vbt_columns">
                  ...
                  >
                    ...
                    <template v-if="hasFilter(column)">
                      <FilterOrder
                        v-if="column.filter.type == 'FilterOrder'"
                        :column="column"
                        :searchSpecialistValue="searchSpecialistValue"
                        @get-column="updateFilter"
                      ></FilterOrder>
                      <MultiSearch
                        v-if="column.filter.type == 'MultiSearch'"
                        :column="column"
                        :searchSpecialistValue="searchSpecialistValue"
                      ></MultiSearch>
                ...
                <div class="row vbt-pagination-row no-gutters">
                  ...
                  <div class="col-md-4">
                    <div class="text-right justify-content-center">
                      ...
                      <template
                        v-if="
                          selected_rows_info && pagination_info && isSelectable
                        "
                      >
...
import { EventBus } from "vue-bootstrap4-table/src/event-bus.js";
...
// workflow - server // get data(payload) // clone to origin_rows // do filter
// do global search // do sort // do paginate
